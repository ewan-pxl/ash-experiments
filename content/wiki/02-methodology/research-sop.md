...
*Open questions:*
- *(Resolved) There are three overlapping vocabularies: the six lenses (Clarity, Relevance, Anxiety, Distraction, Urgency, Value), the "Four Levers" (Motivation, Anxiety, Usability, Offer), and MVIFA whole-page scoring. The call (Ash, 2026-05-30) is to keep all three and use whichever fits the job, rather than force one canonical set: six lenses for element-level diagnosis, MVIFA for whole-page teardown scoring, four levers as the high-level grouping in the hypothesis table.*
